...
public static class AppearanceManager
{
    ...
    public static void ApplyApplicationAppearance(System.Windows.Application application, string requestedAppearance)
    {
    ...
    public static void ApplyWindowSize(Window window, AppConfiguration configuration)
    {
